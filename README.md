...
started” vignette (`vignette("zzz")`), but if you are in a hurry:
...
3.  Save your API key as an [environment
    variable](https://rstats.wtf/r-startup.html#renviron) in
    `.Renviron`.

Now you are ready to turn placenames into coordinates:
...
```
    ...
    ##   <chr>      <dbl>  <dbl> <chr>                  
    ## 1 Sarzeau     47.5  -2.76 Sarzeau, Vannes, France

Or coordinates into placenames:
...
```
    ...
    ##      <dbl>     <dbl> <chr>                                                      
    ## 1     51.5    -0.128 Prime Minister’s Office, 10 Downing Street, London SW1A 2A~

But please read the vignettes, it’s worth it.
