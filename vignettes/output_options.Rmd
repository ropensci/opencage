...
Use of the `oc_forward_df()`/`oc_reverse_df()` functions is demonstrated in the [Introduction to opencage](intro_opencage.html) and the [Customise your query](customise_query.html) vignettes.
...
#> [1] "Wed, 04 Nov 2020 21:52:16 GMT"
#> 
...
#> [1] "Wed, 04 Nov 2020 21:52:19 GMT"
#> 
