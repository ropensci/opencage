...
#>   placename            oc_lat oc_lng oc_formatted                                                   
#>   <chr>                 <dbl>  <dbl> <chr>                                                          
#> 1 Palacio de Bellas A~   19.4 -99.1  Palacio de Bellas Artes, Avenida Juárez, Cuauhtémoc, 06050 Mex~
#> 2 Scala                  45.5   9.19 Teatro alla Scala, Piazza della Scala, Milan Milan, Italy      
#> 3 Sydney Opera House    -33.9 151.   Sydney Opera House, 2 Macquarie Street, Sydney NSW 2000, Austr~
```
...
#> # A tibble: 3 x 31
#>   placename oc_lat oc_lng oc_confidence oc_formatted oc_northeast_lat oc_northeast_lng
#>   <chr>      <dbl>  <dbl>         <int> <chr>                   <dbl>            <dbl>
#> 1 Palacio ~   19.4 -99.1              9 Palacio de ~             19.4           -99.1 
#> 2 Scala       45.5   9.19             9 Teatro alla~             45.5             9.19
#> 3 Sydney O~  -33.9 151.               9 Sydney Oper~            -33.9           151.  
#> # ... with 24 more variables: oc_southwest_lat <dbl>, oc_southwest_lng <dbl>,
#> #   oc_iso_3166_1_alpha_2 <chr>, oc_iso_3166_1_alpha_3 <chr>, oc_category <chr>, oc_type <chr>,
#> #   oc_city <chr>, oc_continent <chr>, oc_country <chr>, oc_country_code <chr>, oc_museum <chr>,
#> #   oc_neighbourhood <chr>, oc_postcode <chr>, oc_road <chr>, oc_attraction <chr>, oc_county <chr>,
#> #   oc_political_union <chr>, oc_square <chr>, oc_state <chr>, oc_suburb <chr>,
...
#>   <chr>            <dbl>  <dbl> <chr>                                                               
#> 1 Elbphilharmonie   53.5   9.98 Elbe Philharmonic Hall, Platz der Deutschen Einheit 1, 20457 Hambur~
#> 2 Concertgebouw     52.4   4.88 Concertgebouw, Concertgebouwplein 2, 1071 LN Amsterdam, The Netherl~
#> 3 Suntory Hall      35.7 140.   Suntory Hall, Karayan Plaza, Akasaka, Minato, Japan
```
...
#>      <dbl>     <dbl> <chr>                                                                          
#> 1     51.5    -0.128 Prime Minister’s Office, Westminster, 10 Downing Street, London SW1A 2AA, Unit~
```
