...
author: "Maëlle Salmon, Daniel Possenriede"
date: "`r Sys.Date()`"
...
Below are two simple examples. When building queries, OpenCage [best practices docs](https://geocoder.opencagedata.com/api#bestpractices) can be very useful.
