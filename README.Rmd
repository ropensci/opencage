...
For the best experience, we recommend that you read through the "Get started" vignette (`vignette("zzz")`), but if you are in a hurry:
...
3. Save your API key as an [environment variable](https://rstats.wtf/r-startup.html#renviron) as `OPENCAGE_KEY=yourkey` in `.Renviron`.
...
But remember, the vignettes are really great!
